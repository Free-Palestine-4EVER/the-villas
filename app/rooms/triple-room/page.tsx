  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <div className="relative h-[60vh]">
        <Image src="/images/triple-room-new.jpeg" alt="Triple Room" fill className="object-cover" priority />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6 md:p-12">
          <h1 className="text-4xl md:text-6xl font-bold text-white text-center mb-4">Triple Room</h1>
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Our Triple Room offers a perfect blend of traditional Bedouin design and modern comfort. Featuring a
                spacious layout with three comfortable single beds, the room provides a cozy retreat for families or
                groups after a day of desert adventures.
              </p>
            ...
            <div className="space-y-6">
              <div className="relative h-80 rounded-lg overflow-hidden">
                <Image src="/images/triple-room-new.jpeg" alt="Triple Room Interior" fill className="object-cover" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative h-40 rounded-lg overflow-hidden">
                  <Image src="/images/room-bathroom.png" alt="Triple Room Bathroom" fill className="object-cover" />
                </div>
                <div className="relative h-40 rounded-lg overflow-hidden">
                  <Image src="/images/room-interior.jpeg" alt="Triple Room View" fill className="object-cover" />
                </div>
                <div className="relative h-40 rounded-lg overflow-hidden">
                  <Image src="/images/room-amenities.jpeg" alt="Triple Room Amenities" fill className="object-cover" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">
              Experience what our Triple Room looks like in 360 virtual reality. Explore every corner of your
          ...
          <div className="text-center">
            ...
            <p className="text-gray-700 mb-8 max-w-3xl mx-auto">
              Experience the magic of Wadi Rum in our comfortable Triple Room. Book now to secure your stay at The
